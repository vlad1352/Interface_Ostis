...
addEquipment_js_path=components/js/addEquipment/addEquipment.js
addEquipment_css_path=components/css/addEquipment.css
...
append_js $sc_web_path/templates/components.html $addEquipment_js_path
append_css $sc_web_path/templates/components.html $addEquipment_css_path
